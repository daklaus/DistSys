...
public interface AuctionServerService {
	 ...
	 * Creates an auction
	 * 
	 * @param owner user which creates the auction
	 * @param description short description of the auction
	 * @param duration how long the auction runs from now (in seconds)
	...
	/**
	 * Lists all auctions in one string. Each auction in one line in the form:
	 ...
	 */
	public void bid(Integer auctionId, double amount);
	
	/**
	 * Logs the user in and binds it to the client
	 * 
	 * @param userName the users name
	 * @param client the client from which the user wants to log in
	 * @return a User object if the login was successful; null otherwise
	 */
	public User login(String userName, Client client);
	
	/**
	 * Logs the user out. This deletes the user and unbinds it from the client.
	 * 
	 * @param client the client from which the user interacts
